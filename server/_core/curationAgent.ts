...
async function research(
  ...
  // web_search_20260209's dynamic filtering runs code execution under the hood —
  // once a response returns a container id, every subsequent request in this run
  // must keep passing it back, or the API 400s with "container_id is required
