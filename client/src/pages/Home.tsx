            ...
            <div className="animate-fade-up">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {[
                    { range: "Below 100", label: "Building", color: "var(--color-muted)" },
                    { range: "100 – 119", label: "Sapphire", color: "#3b82f6" },
                    { range: "120 – 129", label: "Emerald", color: "#10b981" },
                    { range: "130 – 139", label: "Ruby", color: "#ef4444" },
                    { range: "140 – 200", label: "Diamond — Genius Level", color: "#e2e8f0" },
                  ].map((row) => (
